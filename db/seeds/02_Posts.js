  ...
  return knex('posts').del()
    .then(function () {
      ...
      return knex('posts').insert([
        { photo: 'https://s3.us-east-2.amazonaws.com/ig-clone2019/posts/dubai-22.jpg', caption: 'Iam living my life baby #yolo', user_id: 1},
        { photo: 'https://target.scene7.com/is/image/Target/14549692', caption: "I just wanna be the greatest", user_id: 3},
        { photo: 'https://pbs.twimg.com/profile_images/820357473802612736/qGK_QGPM_400x400.jpg', caption: "I wanna travel #yolo", user_id: 2},
